...
const StudentSummaryCard = ({
    ...
    return (
        <div style={{ backgroundColor: theme.palette.background.hex, display: "flex", flexDirection: "column", gap: "2rem" }}>
            {/* Header */}
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: "1rem", fontSize: theme.fontSizes.m, color: theme.palette.text.hex }}>
                    <span>
                    ...
                    <ul style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                        {combinedSkills.map((skill, idx) => {
                            ...
                            const translatedLevel =
                                isHigh ? "Alto" : skill.level === "medium" ? "Medio" : skill.level;
